...
<div class="header_content d-flex align-items-center">
    ...
    <div class="logo_container">
        <div class="logo">
            <a href="../actions_main/mainAuxiliar.jsp"><img src="../images/logo.png" alt=""></a>
        </div>
    </div>
    ...
    <nav class="main_nav_container">
        <div class="main_nav">
            <ul class="main_nav_list">actions_main
                <li class="main_nav_item"><a href="../actions_main/mainAuxiliar.jsp">Inicio</a></li>
