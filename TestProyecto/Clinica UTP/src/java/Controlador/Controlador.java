...
public class Controlador extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (accion) {
            ...
            default:
                ...
                response.sendRedirect(request.getContextPath() + "/actions_others/error.jsp");
        }
    }
    ...
    protected void ingresar(HttpServletRequest request, HttpServletResponse response)
        ...
        if (ro != null) {
            ...
            if (ro.getIdrol() == 1) {
                ...
                response.sendRedirect(request.getContextPath() + "/actions_main/mainAdministrador.jsp");
            }
            if (ro.getIdrol() == 2) {
                //Direccionando
                ...
                response.sendRedirect(request.getContextPath() + "/actions_main/mainPaciente.jsp");
            }
            if (ro.getIdrol() == 3) {
                //Direccionando
                sesion.setAttribute("medico", objPersonal);
                response.sendRedirect(request.getContextPath() + "actions_main/mainMedico.jsp");
            }
            if (ro.getIdrol() == 4) {
                //Direccionando
                sesion.setAttribute("auxiliar", objPersonal);
                response.sendRedirect(request.getContextPath() + "/actions_main/mainAuxiliar.jsp");
            }
            if (ro.getIdrol() == 5) {
                sesion.setAttribute("enfermero", objPersonal);
                response.sendRedirect(request.getContextPath() + "/actions_main/mainEnfermero.jsp");
            }
            if (ro.getIdrol() == 6) {
            ...
            request.getRequestDispatcher("/actions_others/login.jsp").forward(request, response);
        }
    }
    ...
    protected void registrarPaciente(HttpServletRequest request, HttpServletResponse response)
        ...
        //enviando valores al objUsuario
        if (datoSesion.registro(objPaciente)) {
            request.getRequestDispatcher("/actions_list/listarPacientes.jsp").forward(request, response);
        } else {
            response.sendRedirect(request.getContextPath() + "/actions_others/error.jsp");
        }
    }
    ...
    protected void registrarPersonal(HttpServletRequest request, HttpServletResponse response)
        ...
        if (datoSesion.registro(objPersonal)) {
            request.getRequestDispatcher("/actions_list/listarPersonal.jsp").forward(request, response);
        } else {
            response.sendRedirect(request.getContextPath() + "/actions_others/error.jsp");
        }
    }
    ...
    protected void historialClinico(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!listHistorial.isEmpty()) {
            ...
            request.getRequestDispatcher("/actions_history/historialClinico.jsp").forward(request, response);
        } else {
    ...
    protected void listarCita(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/actions_history/historialCitaPaciente.jsp").forward(request, response);
    }
    ...
    protected void actualizarCita(HttpServletRequest request, HttpServletResponse response)
        ...
        if (re.ActualizarSolicitud(objsol,idsoll)) {
            ...
            request.getRequestDispatcher("/actions_reservation/reservarCita.jsp").forward(request, response);
            //response.sendRedirect(request.getContextPath() + "/Controlador?accion=citas");
        } else {
            response.sendRedirect(request.getContextPath() + "/actions_others/error.jsp");
        }
    ...
    private void buscarPaciente(HttpServletRequest request, HttpServletResponse response)
        ...
        if (listHistorial != null) {
            if (!listHistorial.isEmpty()) {
                ...
                request.getRequestDispatcher("/actions_search/buscarPaciente.jsp").forward(request, response);
            }
        } else {
            response.sendRedirect(request.getContextPath() + "/actions_others/error.jsp");
        }
    ...
    private void buscarPacienteE(HttpServletRequest request, HttpServletResponse response)
        ...
        if (listHistorial != null) {
            ...
            request.setAttribute("historial", listHistorial);
            request.setAttribute("receta", listReceta);
            request.getRequestDispatcher("/actions_search/buscarPacienteE.jsp").forward(request, response);
        } else {
            response.sendRedirect(request.getContextPath() + "/actions_others/error.jsp");
        }
    }
    ...
    private void citasPendientes(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/actions_dating/citasPendientesMedico.jsp").forward(request, response);
        /*Gson json = new Gson();
    ...
    private void LaboratorioPendiente(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("citas", info);
        request.getRequestDispatcher("/actions_results_analysis/analisisPendientesAuxiliar.jsp").forward(request, response);
    }
    ...
    protected void guardarHistorial(HttpServletRequest request, HttpServletResponse response)
        ...
        if (objMe.RegistrarHistorial(histo)) {
            ...
            response.sendRedirect(request.getContextPath() + "/actions_search/buscarPaciente.jsp");
        } else {
            response.sendRedirect(request.getContextPath() + "/actions_others/error.jsp");
        }
    }
    ...
    protected void guardarTriaje(HttpServletRequest request, HttpServletResponse response)
        ...
        if (objMe.RegistrarTriaje(triaje, Integer.parseInt(idPaciente))) {
            ...
            response.sendRedirect(request.getContextPath() + "/actions_search/buscarPacienteE.jsp");
        } else {
            response.sendRedirect(request.getContextPath() + "/actions_others/error.jsp");
        }
    }
    ...
    protected void registrarTriaje(HttpServletRequest request, HttpServletResponse response)
        ...
        if (listHistorial != null) {
            ...
            request.setAttribute("receta", listReceta);
            request.getRequestDispatcher("/actions_history/registroTriaje.jsp").forward(request, response);
        } else {
            response.sendRedirect(request.getContextPath() + "/actions_others/error.jsp");
        }
    }
        ...
        if (listHistorial != null) {
            ...
            if (objAuxiliar != null) {
                if (estado.equals("Pendiente")) {
                    ...
                    request.getRequestDispatcher("/actions_results_analysis/resultadoAnalisisAuxiliar.jsp").forward(request, response);
                }
            } else {
                request.getRequestDispatcher("/actions_history/registroHistorialClinico.jsp").forward(request, response);
            }
    ...
    private void ventaFarmacia(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!listHistorial.isEmpty()) {
            if (objPaciente != null) {
                request.setAttribute("historial", listHistorial);
                request.setAttribute("receta", listReceta);
                request.getRequestDispatcher("/actions_pharmacy/farmacia.jsp").forward(request, response);
            } else {
                request.setAttribute("historial", listHistorial);
                request.setAttribute("receta", listReceta);
                request.getRequestDispatcher("/actions_pharmacy/farmaciaFarmaceutica.jsp").forward(request, response);
            }
        } else {
            request.setAttribute("historial", null);
            request.setAttribute("receta", null);
    ...
    private void registrarEspecialidad(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
     ValidarSesion datoSesion = new ValidarSesion();
        ...
        if (datoSesion.registroEspecialidad(objEspecialidad)) {
            request.getRequestDispatcher("/actions_list/listarEspecialidad.jsp").forward(request, response);
        } else {
    ...
    private void registrarHorario(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (datoSesion.registroHorario(objHorario)) {
            request.getRequestDispatcher("/actions_list/listarHorario.jsp").forward(request, response);
        } else {
    ...
    private void editarEspecialidad(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       Especialidad esp = new Especialidad();
        ...
        request.getRequestDispatcher("/actions_add_edit/editarEspecialidad.jsp").forward(request, response);
    }
    ...
    private void editarHorario(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/actions_add_edit/editarHorario.jsp").forward(request, response);
    }
    ...
    private void editarPaciente(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/actions_add_edit/editarPaciente.jsp").forward(request, response);
    }
    ...
    private void editarPersonal(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        pac=objdao.listarId(Integer.parseInt(id));
        request.setAttribute("ep",pac);
        request.getRequestDispatcher("/actions_add_edit/editarPersonal.jsp").forward(request, response);
    }
