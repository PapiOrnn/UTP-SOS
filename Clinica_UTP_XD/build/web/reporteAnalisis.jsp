        ...
        <div class="super_container">
            ...
            <div class="home" style="background-image:url(images/news_background.jpg);">
                ...
                <div class="home_content">
                    <h1>Reporte Analisis de Laboratorio</h1>
    ...
    <table class="records_list table table-striped table-bordered table-hover" id="mydatatable">
        <thead class="thead-dark">
            <tr>
                        ...
                        <th class="text-center">Auxiliar Clinico</th>
                        <th class="text-center">Tipo de Analisis</th>
        ...
        <tbody>
            <%
                    ...
                    List<Solicitud>list=dao.listarAnalisis();
