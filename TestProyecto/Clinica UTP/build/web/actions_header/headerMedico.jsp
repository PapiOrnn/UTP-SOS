...
<div class="header_content d-flex align-items-center">
    ...
    <div class="logo_container">
        <div class="logo">
            <a href="../actions_main/mainMedico.jsp"><img src="../images/logo.png" alt=""></a>
        </div>
    </div>
    ...
    <nav class="main_nav_container">
        <div class="main_nav">
            <ul class="main_nav_list">
                <li class="main_nav_item"><a href="../actions_main/mainMedico.jsp">Inicio</a></li>
                <li class="main_nav_item"><a href="../actions_search/buscarPaciente.jsp">Buscar Paciente</a></li>	
