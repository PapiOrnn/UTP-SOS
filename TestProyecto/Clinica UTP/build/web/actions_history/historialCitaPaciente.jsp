...
<html lang="en">
    ...
    <body>
        ...
        <div class="super_container">
            ...
            <div class="container">
                <div class="row">
                    <!-- Comprobación de si hay citas canceladas o reservadas -->
                    ...
                    <!-- Columna de Publicaciones de Noticias -->
                    <div class="col-lg-12">
                        <!-- Obtener listas de citas de la solicitud -->                        
                        <%
                        ...
                        <div class="leave_comment">
                            ...
                            <br>
                            <!-- Tabla de citas para especialidades -->
                            ...
                            <br>
                            <!-- Tabla de citas para laboratorio -->
