    ...
    <div class="home" style="background-image: url(images/news_background.jpg)">
      <div class="home_content">
        <h1>
          ...
          <span
            class="typed"
            data-typed-items="sads, Devessaloper, Freelanfdsfdscer, dasd"
          ></span>
        </h1>
      </div>
    </div>
        ...
        <div class="row course_boxes">
            ...
            <div class="card">
              ...
              <div class="card-body text-center">
                <div class="card-title">
                  <a href="courses.html">PREDNISONA</a>
                </div>
          ...
          <div class="col-lg-4 course_box">
            <div class="card">
              ...
              <div class="card-body text-center">
                <div class="card-title">
                  <a href="courses.html">FUROSEMIDA</a>
                </div>
          ...
          <div class="col-lg-4 course_box">
            <div class="card">
              ...
              <div class="card-body text-center">
                <div class="card-title">
                  <a href="courses.html">NIRFOL 1% X 1 VIAL</a>
                </div>
          ...
          <div class="col-lg-4 course_box">
            <div class="card">
              ...
              <div class="card-body text-center">
                <div class="card-title">
                  <a href="courses.html">AMOXICLIN</a>
                </div>
                <div class="card-text">
                  12 H 875 MG / 125 MG X 14 COMPRIMIDOS
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 course_box">
            <div class="card">
              ...
              <div class="card-body text-center">
                <div class="card-title">
                  <a href="courses.html">HIPERLIPEN</a>
                </div>
          ...
          <div class="col-lg-4 course_box">
            <div class="card">
              ...
              <div class="card-body text-center">
                <div class="card-title">
                  <a href="courses.html"> IBUPROFENO</a>
                </div>
