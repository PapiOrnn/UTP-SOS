...
<html lang="en"> 
    ...
    <body >
        ...
        <div class="super_container">
            ...
            <div class="leave_comment_title"><a href="../actions_add_edit/agregarPaciente.jsp"><button type="button" class="btn btn-info">Agregar Paciente</button></a></div>
                 ...
                 <tr>
                        ...
                        <td colspan="2">
                            <form method="Post" action="Controlador">
                                 <input type="hidden" name="idPaciente" value="<%=per.getIdPaciente()%>" >
                               <button type="submit" class="btn btn-warning" name="accion" value="editarPaciente">Editar</button>
