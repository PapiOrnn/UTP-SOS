...
<div class="header_content d-flex align-items-center">
    ...
    <div class="logo_container">
        <div class="logo">
            <a href="../actions_main/mainEnfermero.jsp"><img src="../images/logo.png" alt=""></a>
        </div>
    </div>
        ...
        <nav class="main_nav_container">
            <div class="main_nav">
                <ul class="main_nav_list">
                    <li class="main_nav_item"><a href="../actions_main/mainEnfermero.jsp">Inicio</a></li>
                    <li class="main_nav_item"><a href="../actions_search/buscarPacienteE.jsp">Buscar Paciente</a></li>	
                </ul>
            </div>
        </nav>     
    </c:if>
    <c:if test="${farmaceutico.getRol()==6}">     
        <nav class="main_nav_container">
            <div class="main_nav">
                <ul class="main_nav_list">actions_pharmacy
                    <li class="main_nav_item"><a href="../actions_main/mainEnfermero.jsp">Inicio</a></li>
                    <li class="main_nav_item"><a href="Controlador?accion=farmacia">Farmacia</a></li>	
                    <li class="main_nav_item"><a href="../actions_pharmacy/Farmacos.jsp">Farmacos</a></li>	
                </ul>
            </div>
        </nav>
    </c:if>
