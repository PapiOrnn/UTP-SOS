...
<html>
        ...
        <title>Reporte Citas Emergencia</title>
        <!-- Required meta tags -->
        ...
        <div class="super_container">
            ...
            <div class="home" style="background-image:url(../images/news_background.jpg);">
                ...
                <div class="home_content">
                    <h1>Reporte Citas Emergencia</h1>
            ...
            <div class="leave_comment">
                ...
                <div class="leave_comment_title" ><a href="../actions_add_edit/agregarPaciente.jsp" style="margin-left: 950px;"><button type="button" style="font-size: 25px;" class="fas fa-print btn btn-info"></button></a></div>
                <br>
    ...
    <table class="records_list table table-striped table-bordered table-hover" id="mydatatable">
        ...
        <tbody>
            <%
                    ...
                    List<Solicitud>list=dao.listarEmergencia();
                ...
                %>
                 <tr>
                        <td class="text-center"><%= per.getIdSolicitud()%></td>
                        <td class="text-center"><%= per.getIdPaciente()%></td>
                        <td><%= per.getIdPersonal()%></td>
                        <td class="text-center"><%= per.getIdServicio()%></td>
                        <td class="text-center"><%= per.getFecha()%></td>
                        <td class="text-center"><%= per.getIdHorario()%></td>
